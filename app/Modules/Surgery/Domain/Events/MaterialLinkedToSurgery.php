...
class MaterialLinkedToSurgery implements ShouldBroadcastNow
{
    ...
    public function __construct(
        ...
        $this->eventType = 'surgery.material_linked';
    }
    ...
    {
        return 'surgery.material_linked';
    }
